...
class Lease(db.Model):
  ...
  email_pref = Column(Boolean, server_default=expression.false(), default=False, nullable=False)
  text_pref = Column(Boolean, server_default=expression.false(), default=False, nullable=False)
  prob_pref = Column(Integer, server_default=expression.literal(75), default=75, nullable=False)
