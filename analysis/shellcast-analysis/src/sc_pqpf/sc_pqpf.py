...
class SCPQPF:
    def __init__(self, db, save=True):
        ...
        self.data_root = pqpf_dirs.data_root
    ...
    def zonal_stats_to_csv(self) -> str:
        ...
        try:
            ...
            out_csv_path = os.path.join(self.outputs_dir, f'pqpf_cmu_{self.date_today}.csv')
    ...
    def main(self) -> None:
        """
        Runs SC PQPF data extraction and save the results in database.
        """
        start = datetime.now()
