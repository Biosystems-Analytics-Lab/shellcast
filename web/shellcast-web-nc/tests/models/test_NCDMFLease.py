...
def test_NCDMFLease(dbSession):
  validLease1 = NCDMFLease(ncdmf_lease_id='45678', grow_area_name='A01', cmu_name='U001', rainfall_thresh_in=1.5, geometry=(35.803644, -75.985285))
...
def test_asDict():
  lease = NCDMFLease(ncdmf_lease_id='45678', grow_area_name='A01', cmu_name='U001', rainfall_thresh_in=1.5, geometry=(35.803644, -75.985285))
...
def test_repr():
  lease = NCDMFLease(ncdmf_lease_id='45678', grow_area_name='A01', cmu_name='U001', rainfall_thresh_in=1.5)
