...
def test_valid_lease_probs(client, dbSession, addMockFbUser):
    ...
    probabilities = [
        CMUProbability(
            cmu_name="U001", prob_1d_perc=60, prob_2d_perc=70, prob_3d_perc=80
        ),
        CMUProbability(
            cmu_name="U002", prob_1d_perc=45, prob_2d_perc=54, prob_3d_perc=57
        ),
        CMUProbability(
            cmu_name="U003", prob_1d_perc=32, prob_2d_perc=33, prob_3d_perc=69
        ),
    ]
