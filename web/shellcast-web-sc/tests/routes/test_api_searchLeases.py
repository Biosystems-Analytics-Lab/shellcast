...
def test_search_leases(client, dbSession, addMockFbUser):
  ...
  ncdmfLeases = [
    Lease(lease_id='819401', grow_area_name='D11', cmu_name='U001', rainfall_thresh_in=2.5, geometry=(34.404497, -77.567573)),
    Lease(lease_id='123456', grow_area_name='B05', cmu_name='U002', rainfall_thresh_in=3.5, geometry=(35.923741, -76.239482)),
    Lease(lease_id='4-C-89', grow_area_name='A01', cmu_name='U003', rainfall_thresh_in=1.5, geometry=(36.303915, -75.864693))
  ]
...
def test_search_leases_with_existing_user_lease(client, dbSession, addMockFbUser):
  ...
  lease = UserLease(user_id=user.id, lease_id='123456', grow_area_name='B05', cmu_name='U002', rainfall_thresh_in=3.5, geometry=(35.923741, -76.239482))
  dbSession.add(lease)
  dbSession.commit()
