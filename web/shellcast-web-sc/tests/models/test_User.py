...
class TestUserModel:
    ...
    def test_user_soft_delete(self, db_session):
        ...
        active_user = db_session.query(User).filter_by(deleted=False, id=user_id).first()
