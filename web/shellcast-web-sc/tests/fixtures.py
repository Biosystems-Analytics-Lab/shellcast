...
class UserFixtures:
    ...
    def create_active_user(**overrides):
        ...
        return UserFixtures.create_user(
            email_consent=True, email_pref=True, **overrides
        )

    @staticmethod
    def create_deleted_user(**overrides):
        """Create a deleted user."""
        return UserFixtures.create_user(deleted=True, **overrides)
...
class TestDataSets:
    ...
    def basic_user_setup():
        ...
        return {"users": [UserFixtures.create_user()]}

    @staticmethod
    def multiple_users_setup():
        """Setup with multiple users."""
        return {"users": UserFixtures.create_users_batch(3)}
    ...
    def user_with_leases_setup():
        ...
        return {"users": [user], "leases": leases}
    ...
    def complex_setup():
        ...
        return {"users": users, "leases": leases, "notifications": notifications}
