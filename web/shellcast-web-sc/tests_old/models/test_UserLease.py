...
def test_getLatestProbability(dbSession):
  ...
  dbSession.add(user)
  dbSession.commit()
  lease = UserLease(user_id=user.id, lease_id='45678', grow_area_name='A01', cmu_name='U001', rainfall_thresh_in=1.5, geometry=(35.803644, -75.985285))
  dbSession.add(lease)
  dbSession.commit()
...
def test_asDict():
  lease = UserLease(lease_id='45678', grow_area_name='A01', cmu_name='U001', rainfall_thresh_in=1.5, geometry=(35.803644, -75.985285))
